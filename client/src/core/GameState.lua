...
function GameState:drawPlayerStats()
    ...
    -- Обновленная подсказка с дебагом
    love.graphics.setColor(0.8, 0.8, 0.8)
    love.graphics.print("T: Stats, `: Debug", startX + 10, startY + 45)
    -- Добавляем информацию об онлайн-статусе
    love.graphics.setColor(0.8, 0.8, 0.8)
    love.graphics.print("Online: " .. NetworkManager:getPlayerCount() .. " players", 710, 10)
end
